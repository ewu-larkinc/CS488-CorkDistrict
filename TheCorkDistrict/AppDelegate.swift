...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        data.loadData()
        data.translateMapCoordinates()
        
        URL_NOTIFICATIONS = data.getNotificationURL()
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "Madkatz.TheCorkDistrict" in the application's documents Application Support directory.
